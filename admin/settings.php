...
function loadSettingsFromDB($pdo) {
    ...
    return [
        'site' => [
            'title_uk' => 'Тоніровка вікон Харків | Архітектурні та бронювальні плівки | tonirovka.kh.ua',
            'title_ru' => 'Тонировка окон Харьков | Архитектурные и бронирующие пленки | tonirovka.kh.ua',
