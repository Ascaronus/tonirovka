    ...
    function init() {
        ...
        function syncPhone() {
            ...
            [phone, footerPhone, contactsPhone].forEach(link => {
                ...
                if (link === contactsPhone) {
                    let caption = link.querySelector('.contact-phone-caption');
                    if (!caption) {
                        const circle = document.createElement('span');
                        circle.className = 'contact-phone-circle';
                        circle.appendChild(link.querySelector('svg'));
                        caption = document.createElement('span');
                        caption.className = 'contact-phone-caption';
                        link.replaceChildren(circle, caption);
                    }
